...
Version  : 3.3.2
Release  : 77
URL      : http://tarballs.openstack.org/oslo.policy/oslo.policy-3.3.2.tar.gz
Source0  : http://tarballs.openstack.org/oslo.policy/oslo.policy-3.3.2.tar.gz
Source1  : http://tarballs.openstack.org/oslo.policy/oslo.policy-3.3.2.tar.gz.asc
...
%prep
%setup -q -n oslo.policy-3.3.2
cd %{_builddir}/oslo.policy-3.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595896072
...
cp %{_builddir}/oslo.policy-3.3.2/LICENSE %{buildroot}/usr/share/package-licenses/oslo.policy/294b43b2cec9919063be1a3b49e8722648424779
