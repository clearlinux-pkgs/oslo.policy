...
Source0  : http://tarballs.openstack.org/oslo.policy/oslo.policy-1.44.0.tar.gz
Source99 : http://tarballs.openstack.org/oslo.policy/oslo.policy-1.44.0.tar.gz.asc
...
export LANG=C
export SOURCE_DATE_EPOCH=1546552349
