...
Version  : 3.3.0
Release  : 75
URL      : http://tarballs.openstack.org/oslo.policy/oslo.policy-3.3.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.policy/oslo.policy-3.3.0.tar.gz
Source1  : http://tarballs.openstack.org/oslo.policy/oslo.policy-3.3.0.tar.gz.asc
...
%prep
%setup -q -n oslo.policy-3.3.0
cd %{_builddir}/oslo.policy-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594306955
...
cp %{_builddir}/oslo.policy-3.3.0/LICENSE %{buildroot}/usr/share/package-licenses/oslo.policy/294b43b2cec9919063be1a3b49e8722648424779
