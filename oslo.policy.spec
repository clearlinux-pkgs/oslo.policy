...
Version  : 2.3.1
Release  : 60
URL      : http://tarballs.openstack.org/oslo.policy/oslo.policy-2.3.1.tar.gz
Source0  : http://tarballs.openstack.org/oslo.policy/oslo.policy-2.3.1.tar.gz
Source1 : http://tarballs.openstack.org/oslo.policy/oslo.policy-2.3.1.tar.gz.asc
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567648035
