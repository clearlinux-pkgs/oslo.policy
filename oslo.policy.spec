...
Version  : 1.0.0
Release  : 14
URL      : http://tarballs.openstack.org/oslo.policy/oslo.policy-1.0.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.policy/oslo.policy-1.0.0.tar.gz
